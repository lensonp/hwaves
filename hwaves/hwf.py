...
def enclosed_density_radius(n,l,enc_chg,Z=1,N_neut=0):
    ...
    # NOTE: this is not a good use case for a minimizer-
    # the radial wavefunctions inherently present a lot of local minima-
    # need new ideas here.
    # Possibly use a minimizer but start it with some kind of grid search.
    opt = scipimin(enc_chg_diffsqr,2.)
